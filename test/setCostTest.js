...
describe("NFTContract", function () {
  it("Should set new price to attribute cost", async function () {
	...
	const newCost = ethers.utils.parseEther("0.01");
	await myNFT.setCost(newCost)
	const cost = await myNFT.cost();
	expect(cost.eq(newCost)).to.be.true;
